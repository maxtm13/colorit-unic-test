...
<div class="container">
	...
	Array(
        ...
        // Новости
        $APPLICATION->IncludeComponent("bitrix:news", "news_on_main", Array(
...
<div class="container">
 ...
 </section> <section class="section__about">
<div class="container">
	 <?$APPLICATION->IncludeComponent(
	"bitrix:news.detail",
	"about_preview",
	Array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "about_preview",
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "N",
		"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "N",
		...
		"PROPERTY_CODE" => array(0=>"EMAIL",1=>"ADDRESS",2=>"PHONES",3=>"WORK_HOURS",4=>"",),
		"SET_BROWSER_TITLE" => "N",
		"SET_CANONICAL_URL" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
