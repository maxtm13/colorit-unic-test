...
<? $APPLICATION->ShowPanel(); ?>
    <header class="header container py-2 py-md-0">
        <div class="header__wrapper d-none d-md-flex">
            ...
            <div class="header__content_btn">
                <div class="header__content-link link">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        "",
                        array(
        ...
        <div class="header__wrapper header__wrapper-mobile d-flex d-md-none ">
            <div class="header__logo">
                <a href="/" class="header__logo_link">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
            ...
            <div class="d-flex ">
                ...
                <button class="menu-btn">
                    <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect y="8" width="22" height="3" fill="#282828"/>
                        <rect y="16" width="22" height="3" fill="#282828"/>
                    </svg>
    ...
    <section class="anonce">
        <div class="container">
            <div class="anonce__inner row">
                <div class="anonce__item anonce__item_first col-md-4 col-6 order-md-1">
                    <?
                ...
                <div class="anonce__item anonce__item_main col-md-4 col-12 order-3 order-md-2">
                    <? $APPLICATION->IncludeComponent(
                ...
                <div class=" anonce__item anonce__item_second col-md-4 col-6 order-2 order-md-3">
                    <?
                    $APPLICATION->IncludeComponent(
                        "maxtm1:catalog.section.list",
                        "section_pict",
